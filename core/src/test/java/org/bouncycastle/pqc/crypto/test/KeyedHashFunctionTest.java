...
public class KeyedHashFunctionTest extends TestCase {
	...
	public void setUp() {
		...
		System.out.println(Hex.toHexString(addr1.toByteArray()));
		System.out.println(Hex.toHexString(addr2.toByteArray()));
		System.out.println(Hex.toHexString(addr3.toByteArray()));
	}
